<div component="widget/board-stats" class="widget-board-stats">
    ...
    <p>
        <span component="widget/board-stats/count">{count}</span> users active in the past 5 minutes (<span component="widget/board-stats/members">{members}</span> members and <span component="widget/board-stats/guests">{guests}</span> guests).<br />
    ...
    <p>
        ...
        The most users online at one time was {mostUsers.total}, <span class="timeago" title="{mostUsers.timestampISO}"></span>.
    </p>
</div>